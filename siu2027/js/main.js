...
const i18nDictionary = {
  tr: {
    ...
    btnSubmit: "Bildiri Gönder (CMT)",
    btnViewProgram: "Programı Görüntüle",
    btnViewTracks: "Tüm Konu Başlıklarını ve Yazar Yönergelerini İnceleyin",
    ...
    datesFirmNote: "<strong>Kesin son tarih</strong>, ilgili aşama için uzatma yapılmayacak nihai tarihtir. Yazarların planlamalarını ilk sütundaki son tarihe göre yapmaları önerilir.",
    datesKicker: "TAKVİM VE AŞAMALAR",
    datesThDeadline: "Son Tarih",
    datesThFirm: "Kesin Son Tarih",
    ...
    descAuthorsCamera: "PDF format kontrolü & telif",
    descAuthorsCfp: "Resmî çağrı ve bildiri alanları",
    descAuthorsSpecial: "Özel Oturum önerisi gönderme",
    descAuthorsSubmit: "Microsoft CMT başvuru portalı",
    descAuthorsTemplates: "LaTeX & MS Word şablonları",
    descAuthorsTracks: "5 teknik araştırma kulvarı",
    ...
    descProgramDetail: "Gün, salon ve kulvar filtreli",
    descProgramOverview: "4 günlük genel akış takvimi",
    descProgramSocial: "Boğaz turu ve gala yemeği",
    descProgramSpeakers: "Uluslararası davetli bilim insanları",
    descProgramTutorials: "Tutorial ve sanayi panelleri",
    descRegistrationAccom: "Anlaşmalı oteller ve misafirhaneler",
    descRegistrationFaq: "Yazarlar ve katılımcılar için SSS",
    descRegistrationFees: "Erken/normal kayıt tablosu",
    descRegistrationTravel: "Kavacık Kampüsü krokisi & servisler",
    ...
    dr01Desc: "Özel oturum önerilerinin Kurultay Sekreterliği'ne iletilmesi",
    dr01Due: "16 Kasım 2026",
    dr01Firm: "30 Kasım 2026",
    dr01Name: "Özel Oturum Düzenleme Daveti",
    dr01Status: "Aktif Çağrı",
    dr02Desc: "Eğitim semineri (tutorial) önerilerinin iletilmesi",
    dr02Due: "16 Kasım 2026",
    dr02Firm: "30 Kasım 2026",
    ...
    dr08Status: "Etkinlik",
    dt001: "SİU 2027 kapsamında güncel ve özelleşmiş araştırma başlıklarında özel oturumlar düzenlenecektir. Özel oturum düzenlemek isteyen araştırmacıların en geç <strong>16 Kasım 2026</strong> (kesin son tarih: 30 Kasım 2026) tarihine kadar aşağıdaki bilgileri içeren öneri dosyasını <a href=\"mailto:siu2027@medipol.edu.tr\">siu2027@medipol.edu.tr</a> adresine iletmeleri gerekmektedir:",
    dt002: "<strong>Yazar Kaydı:</strong> Bildirinin programda kalması ve IEEE Xplore'a basılabilmesi için yazarlardan en az birinin <strong>24 Mayıs 2027</strong> (kesin son tarih: 31 Mayıs 2027) tarihine kadar kurultay kaydını tamamlaması zorunludur.",
    dt003: "Kabul edilen özel oturumlar <strong>30 Kasım 2026</strong> (kesin son tarih: 14 Aralık 2026) tarihine kadar düzenleyicilere bildirilecektir.",
    dt004: "Oturum başlıkları, salonlar, saatler ve oturumlarda sunulacak bildiriler hakem değerlendirme süreci tamamlandıktan sonra (30 Nisan 2027 sonrası) yayımlanacaktır. Kurultayda bildiri kabul edilen kulvarlar için <a href=\"yazarlar.html#kulvarlar\">Konular ve Araştırma Kulvarları</a> sayfasına bakabilirsiniz.",
    dt005: "SİU 2027 kapsamında yarım günlük eğitim seminerleri (tutorial) ve sanayi panelleri düzenlenecektir. Eğitim semineri önerileri en geç <strong>16 Kasım 2026</strong> (kesin son tarih: 30 Kasım 2026) tarihine kadar Kurultay Sekreterliği'ne iletilmelidir; kabul edilen seminerler <strong>30 Kasım 2026</strong> (kesin son tarih: 14 Aralık 2026) tarihine kadar eğitmenlere bildirilecektir. Kabul edilen başlıklar, gün ve saatleriyle birlikte bu bölümde yayımlanacaktır. <strong>Seminer gün ve saatleri: Belirlenecektir (TBA).</strong>",
    ...
    dt009: "Erken Kayıt",
    dt010: "Kabul edilen ve kurultayda sunulan bildirilerin <strong>IEEE Xplore Dijital Kütüphanesi'ne (IEEE Xplore Digital Library)</strong> aktarılabilmesi ve programda yer alması için yazarlarından en az birinin <strong>24 Mayıs 2027</strong> (kesin son tarih: 31 Mayıs 2027) tarihine kadar kayıt yaptırması zorunludur.",
    dt011: "<strong>İptal ve iade koşulları:</strong> Kayıt iptal talepleri <a href=\"mailto:siu-kayit@medipol.edu.tr\">siu-kayit@medipol.edu.tr</a> adresine yazılı olarak iletilir. <strong>4 Haziran 2027</strong> (kurultaydan 30 gün önce) tarihine kadar iletilen iptal taleplerinde ücretin %75'i iade edilir; bu tarihten sonraki iptallerde ve kurultaya katılmama durumunda iade yapılmaz. Bildirisi programda yer alan ve sunum yükümlülüğü bulunan kayıtlar iade kapsamı dışındadır. Kayıt, aynı kurumdan başka bir katılımcıya devredilebilir.",
    dt012: "<strong>Son Başvuru Tarihi:</strong> Belirlenecektir (TBA)",
    footerAbout: "35. Sinyal İşleme ve İletişim Uygulamaları Kurultayı, İstanbul Medipol Üniversitesi ev sahipliğinde düzenlenmektedir.",
    ...
    hakkindaPageDesc: "35. Sinyal İşleme ve İletişim Uygulamaları Kurultayı'nın (SİU 2027) vizyonu, ev sahibi İstanbul Medipol Üniversitesi ve kurumsal sürekliliği.",
    ...
    hk009: "Sinyal işleme, kablosuz iletişim, görüntü işleme ve yapay zekâ topluluğunun Türkiye'deki en köklü ve saygın bilimsel buluşması olan <strong>Sinyal İşleme ve İletişim Uygulamaları Kurultayı'nın 35.'sini (SİU 2027)</strong>, <strong>04 – 07 Temmuz 2027</strong> tarihlerinde <strong>İstanbul Medipol Üniversitesi</strong> ev sahipliğinde gerçekleştirecek olmanın büyük onurunu ve heyecanını yaşıyoruz.",
    hk010: "1993 yılında Boğaziçi Üniversitesi'nde atılan tohumlar, bugün otuz beşinci yılında Türkiye'nin dört bir yanından ve yurt dışından yüzlerce akademisyeni, genç araştırmacıyı ve savunma/bilişim sanayii temsilcisini bir araya getiren devasa bir bilimsel ekosisteme dönüşmüştür. SİU 2027; klasik sinyal işleme ve telekomünikasyon omurgasını korurken, 6G sistemleri, entegre algılama ve haberleşme (ISAC), büyük dil modelleri (LLM), otonom robotik ve biyomedikal teknolojilerdeki en yeni gelişmeleri odağına almaktadır.",
    hk011: "İstanbul'un eşsiz Boğaz manzarasına komşu Kavacık Kampüsümüzde gerçekleşecek kurultayımızda, hem yüksek nitelikli sözlü ve poster sunumlarıyla bilimsel tartışmalara katılacak hem de zengin sosyal programımızda mesleki bağlarımızı pekiştireceğiz. Tüm araştırmacılarımızı ve sektör temsilcilerimizi SİU 2027'ye davet etmekten kıvanç duyarız.",
    hk012: "SİU 2027 Kurultay Düzenleme Kurulu Adına",
    hk013: "Prof. Dr. Hüseyin Arslan & Prof. Dr. Elif Uysal",
    hk014: "Kurultay Eş Başkanları (Co-Chairs)",
    hk015: "MİSYON VE HEDEFLER",
    hk016: "Kapsam ve Amaç",
    hk017: "SİU Kurultayı'nın temel amacı; sinyal işleme, haberleşme kuramı, bilgisayarlı görü, makine öğrenmesi ve kontrol alanlarında çalışan araştırmacıların özgün çalışmalarını sunabilecekleri, deneyim paylaşımında bulunabilecekleri ve üniversite-sanayi iş birliğini güçlendirebilecekleri ulusal/uluslararası bir zemin sağlamaktır.",
    hk018: "Yüksek Bilimsel Standart",
    hk019: "Tüm bildiriler, alanında yetkin en az iki hakem tarafından çift kör (double-blind) değerlendirmeye tabi tutulur. Kabul edilen ve sunulan bildiriler Kurultay Bildiriler Kitabı'na aktarılır.",
    hk020: "Genç Araştırmacı Desteği",
    hk021: "Lisans Proje Yarışması (LİSPO), 5 Dakikalık Tez Yarışması ve SİU 2027 Seyahat Bursları ile öğrencilerin ve genç akademisyenlerin bilimsel üretime katılımı teşvik edilir.",
    ...
    hk037: "35 YILLIK BİRİKİM",
    hk038: "SİU Tarihçesi ve Süreklilik",
    hk039: "1993 yılında Boğaziçi Üniversitesi'nde 1. Kurultay ile başlayan serüven, aralıksız olarak 35 yıldır sürdürülmektedir. İTÜ, Bilkent, ODTÜ, Koç, Sabancı, Işık, Tarsus ve Piri Reis gibi saygın kurumların ev sahipliğindeki geçmiş kurultayların ayrıntılı listesine ve bildiri kayıtlarına kalıcı arşivimizden ulaşabilirsiniz.",
    hk040: "1993 – 2026 Kurultay Kronolojisini İnceleyin",
    il001: "SEKRETERLİK BİLGİLERİ",
    il002: "İstanbul Medipol Üniversitesi Kavacık Kampüsü",
    ...
    il005: "E-posta Adresleri",
    il006: "Genel İletişim & Bildiriler: <a href=\"mailto:siu2027@medipol.edu.tr\">siu2027@medipol.edu.tr</a><br> Kayıt & Muhasebe: <a href=\"mailto:siu-kayit@medipol.edu.tr\">siu-kayit@medipol.edu.tr</a>",
    il007: "Telefon & Çağrı Merkezi",
    il008: "+90 (216) 681 51 00 (Santral) • Dahili: 2027",
    il009: "Konum ve Otopark Bilgisi",
    il010: "Katılımcılarımız için Kavacık Güney Kampüsü kapalı otoparkı kurultay süresince ücretsiz olarak hizmet verecektir. Navigasyon için: <em>\"İstanbul Medipol Üniversitesi Kavacık Güney Kampüsü\"</em>.",
    ...
    il018: "Bildiri Gönderimi ve CMT Desteği",
    il019: "Kayıt ve Ücret İşlemleri",
    il020: "Özel Oturum Başvurusu",
    il021: "Lisans Proje / Tez Yarışması",
    il022: "Sponsorluk ve Sergi Alanları",
    il023: "Diğer / Genel Soru",
    il024: "Mesajınız *",
    il025: "<a href=\"kvkk.html\">KVKK Aydınlatma Metni</a>'ni okudum; ad, soyad, e-posta ve kurum bilgilerimin talebimin karşılanması amacıyla işlenmesini kabul ediyorum. *",
    ...
    ix008: "Bilgi Teorisi, Kodlama ve İletişim Teorisi",
    ix009: "Kablosuz ve Hücresel Ağlar (5G, 6G ve Ötesi)",
    ix010: "Bütünleşik Algılama ve İletişim (ISAC)",
    ix011: "Karasal Olmayan Ağlar (NTN, Uydu ve İHA)",
    ix012: "Akıllı Yansıtıcı Yüzeyler (RIS) ve Holografik MIMO",
    ix013: "Ağ Güvenliği, Mahremiyet ve Kuantum İletişim",
    ix014: "Görüntü ve Video İşleme / Kodlama / Sıkıştırma",
    ix015: "Nesne Tespiti, Takibi ve Örüntü Tanıma",
    ix016: "Görüntü ve Video Tabanlı Biyometrik Sistemler",
    ix017: "3B Görüntü ve Hesaplamalı Fotoğrafçılık",
    ix018: "Uzaktan Algılama ve Coğrafi Analiz",
    ix019: "Belge Analizi ve Anlama",
    ix020: "İstatistiksel ve Doğrusal Olmayan İşaret İşleme",
    ix021: "Ses, Konuşma ve Akustik Sinyal Analizi",
    ix022: "Radar, Sonar ve Dizi Sinyal İşleme",
    ix023: "Robotik, Otomasyon ve Otonom Sistemler",
    ix024: "Gerçek Zamanlı Sinyal İşleme ve Gömülü Sistemler",
    ix025: "Akıllı Şehirler, Şebekeler ve Sensör Füzyonu",
    ix026: "Makine Öğrenmesi Kuramı ve Derin Öğrenme",
    ix027: "Doğal Dil İşleme, LLM ve Metin Madenciliği",
    ix028: "İletişim ve İşaret Sistemleri için Makine Öğrenmesi",
    ix029: "Açıklanabilir ve Güvenilir Yapay Zekâ (XAI)",
    ix030: "Üretken Modeller, Pekiştirmeli Öğrenme",
    ix031: "Çok Modlu (Multimodal) Analiz ve TinyML",
    ix032: "Biyomedikal Sinyal Analizi (EEG, EKG, EMG vb.)",
    ix033: "Tıbbi Görüntü Analizi (MR, BT, Ultrason vb.)",
    ix034: "Tıbbi Tanıda Yapay Zekâ Destekli Çözümler",
    ix035: "Biyoinformatik ve Genomik Sinyal İşleme",
    ix036: "Giyilebilir Sensörler, Tele-Tıp ve E-Sağlık",
    ix037: "Nöromühendislik ve Beyin-Bilgisayar Arayüzleri",
    ...
    keyDateVal: "04 – 07 Temmuz 2027",
    keyDeadlineSub: "Kesin son tarih: 1 Mart 2027 • CMT, en fazla 4 sayfa",
    keyDeadlineTitle: "Bildiri Son Tarihi",
    keyDeadlineVal: "1 Şubat 2027",
    keyLocationSub: "Kavacık Kampüsü, Beykoz",
    keyLocationTitle: "Kurultay Yeri",
    keyLocationVal: "Medipol / İstanbul",
    keynotesDesc: "SİU 2027 kapsamında planlanan davetli konuşmalar ve konuşmacılar, davetler teyit edildikçe duyurulacaktır.",
    keynotesPendingCta: "PROGRAM SAYFASINA GİT",
    keynotesPendingDesc: "SİU 2027 kapsamında üç davetli konuşma (keynote) planlanmaktadır. Konuşmacılar ve konuşma başlıkları, davetler teyit edildikçe bu bölümde ilan edilecektir.",
    keynotesPendingTitle: "Davetli konuşmacılar henüz kesinleşmemiştir.",
    keynotesTitle: "Davetli Konuşmacılar",
    km001: "Kurultay Eş Başkanları (Co-Chairs)",
    km002: "Kurultay Eş Başkanı",
    km003: "Kurultay Eş Başkanı",
    km004: "Teknik Program Komitesi Eş Başkanları (TPC Co-Chairs)",
    ...
    komitelerPageDesc: "SİU 2027 Kurultay Eş Başkanları, Teknik Program Komitesi (TPC), Oturum ve Alan Başkanları.",
    ...
    kt063: "İlk bildirisi tam/öğrenci kaydedilmiş yazarın IEEE Xplore'a basılacak 2. ve sonraki bildirileri için.",
    ...
    kt073: "Maddi desteğe ihtiyaç duyan öğrenciler için sınırlı sayıda seyahat ve ücretsiz kayıt bursu tahsis edilecektir (<a href=\"yarisma.html#destek\">Seyahat Desteği Sayfası</a>).",
    kt074: "OTEL VE KONUKEVLERİ",
    kt075: "Konaklama Seçenekleri",
    kt076: "Kurultay katılımcılarımız için Kavacık çevresindeki konaklama seçenekleri ile öğrenciler ve genç araştırmacılar için üniversite yurtları aşağıda listelenmiştir:",
    ...
    kv029: "Konaklama sayfasındaki harita, OpenStreetMap projesinin açık karo (tile) sunucularından görsel çeker. Bu sırada tarayıcınızın IP adresi ilgili sunuculara iletilir; çerez kullanılmaz. Harita kitaplığı (Leaflet) üçüncü taraf bir sunucudan değil, doğrudan bu web sitesinden sunulmaktadır.",
    ...
    navAuthorsSubmit: "Bildiri Gönderimi (CMT)",
    navAuthorsTemplates: "Yazar Yönergeleri & Şablonlar",
    ...
    navProgramTutorials: "Eğitim Seminerleri & Paneller",
    navQuickSubmit: "Bildiri Gönder",
    ...
    newsDesc1: "SİU 2027 bildiri kabul süreci Microsoft CMT sistemi üzerinden açılmıştır. Tüm bildiriler çift kör hakemlik sürecinden geçecektir.",
    newsDesc2: "35. Kurultay, Medipol Üniversitesi Kavacık Güney Kampüsü Kongre ve Kültür Merkezi'nin çağdaş amfi ve salonlarında gerçekleştirilecektir.",
    newsDesc3: "SİU 2027 IEEE Türkiye Section teknik sponsorluğunda, kurultayda sunulan tam metin bildiriler IEEE Xplore veri tabanına iletilecektir.",
    newsDesc4: "SİU Lisans Proje Yarışması (LİSPO), 5 Dakikalık Tez Yarışması ve şehir dışından gelen öğrenciler için seyahat fonu çağrısı duyuruldu.",
    newsTag1: "BİLDİRİ ÇAĞRISI",
    newsTag2: "EV SAHİBİ",
    newsTag3: "YAYIN VE İNDEKS",
    newsTag4: "ÖĞRENCİ DESTEK",
    newsTitle1: "SİU 2027 Bildiri Çağrısı Yayımlandı (Son Tarih: 1 Şubat 2027)",
    newsTitle2: "SİU 2027 Ev Sahibi: İstanbul Medipol Üniversitesi Kavacık Kampüsü",
    newsTitle3: "Sunulan Tüm Bildiriler IEEE Xplore Dijital Kütüphanesinde Yayımlanacaktır",
    newsTitle4: "Lisans Proje Yarışması ve Seyahat Desteği Başvuruları Açıldı",
    nf001: "HATA 404",
    ...
    nf004: "<a href=\"/\" class=\"btn btn--primary\">Ana Sayfa</a> <a href=\"/yazarlar.html#cfp\" class=\"btn\">Bildiri Çağrısı</a> <a href=\"/program.html\" class=\"btn\">Bilimsel Program</a> <a href=\"/katilim.html#kayit\" class=\"btn\">Kayıt ve Ücretler</a> <a href=\"/iletisim.html\" class=\"btn\">İletişim</a>",
    ...
    pr074: "Davetli konuşmacılar henüz kesinleşmemiştir.",
    pr075: "SİU 2027 kapsamında üç davetli konuşma (keynote) planlanmaktadır. Konuşmacılar ve konuşma başlıkları, davetler teyit edildikçe bu bölümde ve kurultay duyurularında ilan edilecektir.",
    pr076: "EĞİTİM SEMİNERLERİ (TUTORIAL) VE PANELLER",
    pr077: "Eğitim Seminerleri ve Paneller",
    ...
    programPageDesc: "4 günlük genel akış, gün, salon ve kulvar bazında filtrelenebilen bilimsel oturumlar, davetli konuşmalar ve paneller.",
    ...
    sponsorsPending: "Kurumsal sponsorluk ve sergi alanı görüşmeleri sürmektedir. Destekçi kuruluşlar teyit edildikçe bu bölümde duyurulacaktır.",
    sponsorsTierHost: "EV SAHİBİ VE DÜZENLEYEN KURULUŞLAR",
    sponsorsTierTech: "TEKNİK SPONSORLUK",
    tba101: "SİU 2027, 04 – 07 Temmuz 2027 tarihleri arasında dört gün sürecektir.",
    tba102: "Günlük program akışı — Belirlenecektir (TBA)",
    ...
    tba105: "Oturum çizelgesi — Belirlenecektir (TBA)",
    tba107: "BİLDİRİ ÇAĞRISINA GİT",
    tba109: "Sosyal Program — Belirlenecektir (TBA)",
    tba110: "Kurultay kapsamında bir gala yemeği ve sosyal etkinlik programı planlanmaktadır. Etkinliklerin içeriği, tarihi, yeri ve kayıt kapsamına dâhil olup olmadığı kesinleştiğinde bu bölümde ve kurultay duyurularında ilan edilecektir.",
    tba201: "TBA",
    tba202: "Ücretler kesinleştiğinde duyurulacaktır",
    tba203: "Gala yemeği bileti: TBA",
    ...
    theLatestKicker: "SON GELİŞMELER & DUYURULAR",
    topbarDate: "04–07 Temmuz 2027 | İstanbul",
    topbarSearchBtn: "Arama",
    track1Badge: "Kablosuz Ağlar & 6G",
    track1Title: "İletişim ve Ağlar",
    track2Badge: "Görüntü & Bilgisayarlı Görü",
    track2Title: "Görüntü İşleme ve Bilgisayarlı Görü",
    track3Badge: "Sinyal İşleme Kuramı & Uygulama",
    track3Title: "Sinyal İşleme ve Uygulamaları",
    track4Badge: "Makine Öğrenmesi & YZ",
    track4Title: "Makine Öğrenmesi ve Yapay Zekâ",
    track5Badge: "Biyomedikal & Sağlık Teknolojileri",
    track5Title: "Biyomedikal Sinyal ve Görüntü İşleme",
    trackNum1: "KULVAR 01",
    trackNum2: "KULVAR 02",
    trackNum3: "KULVAR 03",
    trackNum4: "KULVAR 04",
    trackNum5: "KULVAR 05",
    tracksDesc: "SİU kurultayının geleneksel ve resmî yapısını oluşturan 5 ana teknik araştırma kulvarı.",
    ...
    yazarlarPageDesc: "Bildiri çağrısı (CFP), Microsoft CMT başvuru sistemi, standart çift sütun şablonları, çift kör hakemlik kuralları ve özel oturum önerileri.",
    ...
    yr027: "İstanbul Medipol Üniversitesi ve kurultay sponsorlarının katkılarıyla, İstanbul dışından gelerek kabul edilen bildirisini sözlü veya poster olarak sunacak ihtiyaç sahibi lisans ve lisansüstü öğrencilere <strong>ulaşım ve ücretsiz kayıt desteği</strong> sağlanacaktır.",
    ...
    yz003: "• Konular ve Kulvarlar (5 Kulvar)",
    ...
    yz011: "35. Sinyal İşleme ve İletişim Uygulamaları Kurultayı (SİU 2027), <strong>04 – 07 Temmuz 2027</strong> tarihleri arasında <strong>İstanbul Medipol Üniversitesi</strong> Kavacık Kampüsü'nde gerçekleştirilecektir.",
    ...
    yz020: "Kabul edilen ve sunulan tam metin bildiriler IEEE Xplore Dijital Kütüphanesi'ne gönderilecektir.",
    yz022: "CMT Bildiri Gönderim Sistemi",
    yz023: "RESMÎ KULVARLAR",
    yz024: "Konular ve Araştırma Kulvarları",
    yz025: "SİU 2027, aşağıda sıralanan <strong>5 resmî ana başlık</strong> ve ilgili alt konularda özgün araştırma bildirileri kabul etmektedir. Bu başlıkların yanı sıra sinyal işleme ve iletişimin kuramsal ve uygulamalı her alanından özgün bildiriler değerlendirmeye açıktır:",
    yz026: "Kulvar 1: İletişim ve Ağlar",
    yz027: "<span>• Bilgi Teorisi ve Kodlama</span> <span>• İletişim Teorisi ve Uygulamaları</span> <span>• Kablosuz İletişim ve Ağlar</span> <span>• 5G, 6G ve Ötesi Teknolojiler</span> <span>• Bütünleşik Algılama ve İletişim (ISAC)</span> <span>• Nesnelerin İnterneti (IoT) ve Taşıtsal İletişim</span> <span>• Uydu, Derin Uzay ve Karasal Olmayan Ağlar (NTN)</span> <span>• Akıllı Yansıtıcı Yüzeyler (RIS) ve MIMO</span> <span>• Optik, Kuantum ve Moleküler İletişim</span> <span>• Ağ Güvenliği, Mahremiyet ve Fiziksel Katman Güvenliği</span> <span>• Uç Bilişim, Uç Zekâsı ve Sis Ağları</span> <span>• Enerji Hasadı, Yeşil Ağlar ve Özkaynak Tahsisi</span>",
    yz028: "Kulvar 2: Görüntü İşleme ve Bilgisayarlı Görü",
    yz029: "<span>• Görüntü ve Video İşleme</span> <span>• Görüntü/Video Kodlama ve Sıkıştırma</span> <span>• Nesne Algılama, Takibi ve Örüntü Tanıma</span> <span>• Biyometrik Tanıma ve Yüz İşleme</span> <span>• Çok Kanallı ve Çok Kameralı Sistemler</span> <span>• Uzaktan Algılama ve Coğrafi Analiz</span> <span>• 3B Rekonstrüksiyon ve Hesaplamalı Fotoğrafçılık</span> <span>• Belge Analizi, Anlama ve OCR</span>",
    yz030: "Kulvar 3: Sinyal İşleme ve Uygulamaları",
    yz031: "<span>• İstatistiksel ve Doğrusal Olmayan Sinyal İşleme</span> <span>• Ses, Konuşma ve Akustik Sinyal Analizi</span> <span>• Radar, Sonar ve Dizi Sinyal İşleme</span> <span>• Akıllı Şehir ve Akıllı Şebeke Uygulamaları</span> <span>• Otonom Sistemler için Sinyal İşleme</span> <span>• Robotik, Otomasyon ve Kontrol</span> <span>• Endüstriyel ve Otomotiv Uygulamaları</span> <span>• Gerçek Zamanlı Sinyal İşleme ve Gömülü Sistemler</span> <span>• Sensör Füzyonu ve Finansal Sinyal İşleme</span> <span>• İnsan-Bilgisayar Etkileşimi ve Davranış Analizi</span>",
    yz032: "Kulvar 4: Makine Öğrenmesi ve Yapay Zekâ",
    yz033: "<span>• Makine Öğrenmesi Kuramı ve Optimizasyon</span> <span>• Derin Öğrenme Mimarileri ve Modelleri</span> <span>• Doğal Dil İşleme, LLM ve Metin Madenciliği</span> <span>• İletişim ve İşaret Sistemleri İçin Yapay Zekâ</span> <span>• Açıklanabilir ve Güvenilir Yapay Zekâ (XAI)</span> <span>• Çekişmeli Öğrenme ve Dayanıklı Yapay Zekâ</span> <span>• Aktarmalı, Yarı Gözetimli ve Pekiştirmeli Öğrenme</span> <span>• Çok Modlu (Multimodal) Analiz ve TinyML</span> <span>• Denetimsiz ve Üretken Modeller (Diffusion, GAN)</span> <span>• Makine Öğrenmesi Tekniklerinin Başarım Analizi</span>",
    yz034: "Kulvar 5: Biyomedikal Sinyal/Görüntü İşleme ve Uygulamaları",
    yz035: "<span>• Biyomedikal Sinyal Analizi (EEG, EKG, EMG vb.)</span> <span>• Tıbbi Görüntü Analizi ve Uygulamaları (MR, BT, Ultrason)</span> <span>• Biyoinformatik ve Genomik Sinyal İşleme</span> <span>• Giyilebilir Algılayıcılar ve E-Sağlık Çözümleri</span> <span>• Biyomedikal Veri Gizliliği ve Güvenliği</span> <span>• Tıbbi Tanıda Yapay Zekâ Uygulamaları</span> <span>• Sağlık İzleme için Biyosinyal İşleme</span> <span>• Tele-Tıp ve Uzaktan Hasta Takibi</span> <span>• Nöromühendislik ve Beyin Sinyali İşleme</span> <span>• Biyomedikal Cihaz ve Enstrümantasyon</span>",
    ...
    yz046: "Bildiri gönderimleri yalnızca resmî Microsoft CMT (Conference Management Toolkit) sistemi üzerinden kabul edilmektedir. E-posta yoluyla gönderilen bildiriler işleme alınmayacaktır.",
    yz047: "Adım Adım Gönderim Süreci:",
    yz048: "<a href=\"https://cmt3.research.microsoft.com/SIU2027\" target=\"_blank\" rel=\"noopener\">Microsoft CMT SİU 2027 Bağlantısına</a> tıklayın ve hesabınızla giriş yapın.",
    ...
    yz054: "Microsoft CMT SİU 2027 Başvuru Portalı",
    ...
    ky023: "Zorunlu alan",
    ky024: "Kayıt kapsamı ve ücretler",
    ky025: "Ücret tablosu, kayıt kapsamı ve iptal/iade koşulları Katılım ve Kayıt sayfasındadır.",
    ...
    ft002: "Bildiri Gönderimi (CMT)",
    ft003: "Bildiri Şablonları (LaTeX/Word)",
    ft004: "Bilimsel Program",
    ft005: "Kayıt Ücretleri",
    ft006: "Lisans Proje Yarışması",
    ft007: "Kurultay Başkanları",
  ...
  en: {
    ...
    btnSubmit: "Submit Paper (CMT)",
    btnViewProgram: "View Program",
    btnViewTracks: "Explore All Track Topics and Author Guidelines",
    ...
    datesFirmNote: "The <strong>firm deadline</strong> is the final date for each milestone; no extension will be granted beyond it. Authors are advised to plan according to the deadline in the first column.",
    datesKicker: "TIMELINE & MILESTONES",
    datesThDeadline: "Deadline",
    datesThFirm: "Firm Deadline",
    ...
    descAuthorsCamera: "PDF format check & copyright",
    descAuthorsCfp: "Official call and paper topics",
    descAuthorsSpecial: "Submit special session proposal",
    descAuthorsSubmit: "Microsoft CMT submission portal",
    descAuthorsTemplates: "LaTeX & MS Word templates",
    descAuthorsTracks: "5 technical research tracks",
    ...
    descProgramDetail: "Filter by day, hall and track",
    descProgramOverview: "4-day overall conference schedule",
    descProgramSocial: "Bosphorus cruise & banquet",
    descProgramSpeakers: "Distinguished keynote scholars",
    descProgramTutorials: "Tutorials & industrial panels",
    descRegistrationAccom: "Contracted hotels & guest houses",
    descRegistrationFaq: "FAQ for authors and attendees",
    descRegistrationFees: "Early bird & standard rates",
    descRegistrationTravel: "Kavacik campus map & shuttles",
    ...
    dr01Desc: "Submission of special session proposals to the Conference Secretariat",
    dr01Due: "16 November 2026",
    dr01Firm: "30 November 2026",
    dr01Name: "Call for Special Session Proposals",
    dr01Status: "Open",
    dr02Desc: "Submission of tutorial proposals",
    dr02Due: "16 November 2026",
    dr02Firm: "30 November 2026",
    dr02Name: "Call for Tutorial Proposals",
    dr02Status: "Open",
    dr03Desc: "Accepted special sessions announced to organisers",
    dr03Due: "30 November 2026",
    dr03Firm: "14 December 2026",
    ...
    dr04Due: "30 November 2026",
    dr04Firm: "14 December 2026",
    ...
    dr07Due: "24 May 2027",
    dr07Firm: "31 May 2027",
    dr07Name: "Camera-Ready Paper Submission",
    dr07Status: "Scheduled",
    dr08Desc: "Istanbul Medipol University, Kavacık South Campus",
    dr08Due: "4 – 7 July 2027",
    dr08Name: "Conference Dates",
    dr08Status: "Event",
    dt001: "Special sessions on current and specialised research topics will be organised within SIU 2027. Researchers wishing to organise a special session should send a proposal containing the following information to <a href=\"mailto:siu2027@medipol.edu.tr\">siu2027@medipol.edu.tr</a> by <strong>16 November 2026</strong> (firm deadline: 30 November 2026) at the latest:",
    dt002: "<strong>Author Registration:</strong> for the paper to remain in the programme and be published in IEEE Xplore, at least one author must complete conference registration by <strong>24 May 2027</strong> (firm deadline: 31 May 2027).",
    dt003: "Organisers will be notified of accepted special sessions by <strong>30 November 2026</strong> (firm deadline: 14 December 2026).",
    dt004: "Session titles, halls, timings and the papers to be presented will be published once the peer review process is complete (after 30 April 2027). For the tracks in which papers are accepted, see the <a href=\"yazarlar.html#kulvarlar\">Topics and Research Tracks</a> page.",
    dt005: "Half-day tutorials and industry panels will be held as part of SIU 2027. Tutorial proposals must be sent to the Conference Secretariat by <strong>16 November 2026</strong> (firm deadline: 30 November 2026); instructors will be notified of accepted tutorials by <strong>30 November 2026</strong> (firm deadline: 14 December 2026). Accepted titles will be published in this section together with their dates and times. <strong>Tutorial dates and times: To Be Announced (TBA).</strong>",
    ...
    dt010: "For accepted papers presented at the conference to be submitted to the <strong>IEEE Xplore Digital Library</strong> and included in the programme, at least one of their authors must register by <strong>24 May 2027</strong> (firm deadline: 31 May 2027).",
    dt011: "<strong>Cancellation and refund terms:</strong> cancellation requests must be submitted in writing to <a href=\"mailto:siu-kayit@medipol.edu.tr\">siu-kayit@medipol.edu.tr</a>. For cancellations received by <strong>4 June 2027</strong> (30 days before the conference), 75% of the fee is refunded; no refund is made for cancellations after that date or for non-attendance. Registrations covering a paper that appears in the programme and carries a presentation obligation are excluded from refunds. A registration may be transferred to another participant from the same institution.",
    dt012: "<strong>Application Deadline:</strong> To Be Announced (TBA)",
    footerAbout: "35th Signal Processing and Communications Applications Conference, hosted by Istanbul Medipol University.",
    ...
    hakkindaPageDesc: "Vision of the 35th Signal Processing and Communications Applications Conference (SIU 2027), host Istanbul Medipol University, and institutional legacy.",
    ...
    hk005: "• History of SIU (1993–2027)",
    ...
    hk009: "We are honoured and delighted to host the <strong>35th Signal Processing and Communications Applications Conference (SIU 2027)</strong> — the longest-standing and most respected scientific gathering of the signal processing, wireless communications, image processing and artificial intelligence community in Türkiye — on <strong>4–7 July 2027</strong> at <strong>Istanbul Medipol University</strong>.",
    hk010: "What began at Boğaziçi University in 1993 has, in its thirty-fifth year, grown into a substantial scientific ecosystem that brings together hundreds of academics, early-career researchers and representatives of the defence and information technology industries from across Türkiye and abroad. While preserving the classical signal processing and telecommunications backbone, SIU 2027 focuses on the latest developments in 6G systems, integrated sensing and communication (ISAC), large language models (LLMs), autonomous robotics and biomedical technologies.",
    hk011: "At our Kavacık Campus, overlooking the incomparable Bosphorus, the conference will offer both high-quality oral and poster presentations for scientific discussion and a rich social programme in which to strengthen professional ties. We are pleased to invite all researchers and industry representatives to SIU 2027.",
    ...
    hk017: "The core aim of the SIU Conference is to provide a national and international platform on which researchers working in signal processing, communication theory, computer vision, machine learning and control can present original work, share experience and strengthen university–industry collaboration.",
    hk018: "High Scientific Standards",
    hk019: "All papers undergo double-blind review by at least two qualified reviewers in the field. Papers that are accepted and presented are included in the Conference Proceedings.",
    hk020: "Support for Early-Career Researchers",
    hk021: "The Undergraduate Project Competition (LİSPO), the 5-Minute Thesis Competition and the SIU 2027 travel grants encourage students and early-career academics to take part in scientific production.",
    ...
    hk037: "35 YEARS OF EXPERIENCE",
    hk038: "The History and Continuity of SIU",
    hk039: "The journey that began with the 1st Conference at Boğaziçi University in 1993 has continued without interruption for 35 years. A detailed list of past conferences hosted by respected institutions such as İTÜ, Bilkent, METU, Koç, Sabancı, Işık, Tarsus and Piri Reis, together with their paper records, is available in our permanent archive.",
    hk040: "Browse the 1993–2026 Conference Chronology",
    il001: "SECRETARIAT INFORMATION",
    il002: "Istanbul Medipol University Kavacık Campus",
    ...
    il005: "E-mail Addresses",
    il006: "General enquiries & papers: <a href=\"mailto:siu2027@medipol.edu.tr\">siu2027@medipol.edu.tr</a><br> Registration & accounting: <a href=\"mailto:siu-kayit@medipol.edu.tr\">siu-kayit@medipol.edu.tr</a>",
    il007: "Telephone & Call Centre",
    il008: "+90 (216) 681 51 00 (switchboard) • Ext.: 2027",
    il009: "Location and Parking",
    il010: "The covered car park at the Kavacık South Campus will be available free of charge to participants for the duration of the conference. For navigation, search for: <em>\"İstanbul Medipol Üniversitesi Kavacık Güney Kampüsü\"</em>.",
    ...
    il018: "Paper Submission and CMT Support",
    ...
    il024: "Your Message *",
    il025: "I have read the <a href=\"kvkk.html\">Personal Data Protection (KVKK) Notice</a> and consent to my name, surname, e-mail address and institution being processed in order to handle my request. *",
    ...
    ix008: "Information Theory, Coding and Communication Theory",
    ix009: "Wireless and Cellular Networks (5G, 6G and Beyond)",
    ix010: "Integrated Sensing and Communication (ISAC)",
    ix011: "Non-Terrestrial Networks (NTN, Satellite and UAV)",
    ix012: "Reconfigurable Intelligent Surfaces (RIS) and Holographic MIMO",
    ix013: "Network Security, Privacy and Quantum Communication",
    ix014: "Image and Video Processing / Coding / Compression",
    ix015: "Object Detection, Tracking and Pattern Recognition",
    ix016: "Image- and Video-Based Biometric Systems",
    ix017: "3D Imaging and Computational Photography",
    ix018: "Remote Sensing and Geospatial Analysis",
    ix019: "Document Analysis and Understanding",
    ix020: "Statistical and Nonlinear Signal Processing",
    ix021: "Audio, Speech and Acoustic Signal Analysis",
    ix022: "Radar, Sonar and Array Signal Processing",
    ix023: "Robotics, Automation and Autonomous Systems",
    ix024: "Real-Time Signal Processing and Embedded Systems",
    ix025: "Smart Cities, Smart Grids and Sensor Fusion",
    ix026: "Machine Learning Theory and Deep Learning",
    ix027: "Natural Language Processing, LLMs and Text Mining",
    ix028: "Machine Learning for Communication and Signal Systems",
    ix029: "Explainable and Trustworthy Artificial Intelligence (XAI)",
    ix030: "Generative Models and Reinforcement Learning",
    ix031: "Multimodal Analysis and TinyML",
    ix032: "Biomedical Signal Analysis (EEG, ECG, EMG, etc.)",
    ix033: "Medical Image Analysis (MRI, CT, Ultrasound, etc.)",
    ix034: "AI-Assisted Solutions in Medical Diagnosis",
    ix035: "Bioinformatics and Genomic Signal Processing",
    ix036: "Wearable Sensors, Telemedicine and E-Health",
    ix037: "Neuroengineering and Brain–Computer Interfaces",
    ...
    keyDateVal: "July 04 – 07, 2027",
    keyDeadlineSub: "Firm deadline: 1 March 2027 • CMT, 4 pages max",
    keyDeadlineTitle: "Paper Submission Deadline",
    keyDeadlineVal: "1 February 2027",
    keyLocationSub: "Kavacik Campus, Beykoz, Istanbul",
    keyLocationTitle: "Venue",
    keyLocationVal: "Medipol / Istanbul",
    keynotesDesc: "The invited talks planned for SIU 2027 and their speakers will be announced as invitations are confirmed.",
    keynotesPendingCta: "GO TO THE PROGRAMME PAGE",
    keynotesPendingDesc: "Three invited talks (keynotes) are planned for SIU 2027. Speakers and talk titles will be announced in this section as invitations are confirmed.",
    ...
    komitelerPageDesc: "SIU 2027 General Co-Chairs, Technical Program Committee (TPC), Session and Track Chairs.",
    ...
    kt063: "For the 2nd and subsequent papers to be published in IEEE Xplore by an author whose first paper is covered by a full/student registration.",
    ...
    kt073: "A limited number of travel grants and free registrations will be allocated to students in financial need (<a href=\"yarisma.html#destek\">Travel Support page</a>).",
    kt074: "HOTELS AND GUESTHOUSES",
    kt075: "Accommodation Options",
    kt076: "Accommodation options around Kavacık for conference participants, together with university halls of residence for students and early-career researchers, are listed below:",
    ...
    kv029: "The map on the accommodation page loads imagery from the OpenStreetMap project's public tile servers. In doing so, your browser's IP address is transmitted to those servers; no cookies are used. The map library (Leaflet) is served directly from this website, not from a third-party server.",
    ...
    navAuthorsSubmit: "Paper Submission (CMT)",
    navAuthorsTemplates: "Author Guidelines & Templates",
    ...
    navProgramTutorials: "Tutorials & Panels",
    navQuickSubmit: "Submit Paper",
    ...
    newsDesc1: "Paper submissions are officially open via Microsoft CMT. All submissions will undergo rigorous double-blind peer review.",
    newsDesc2: "The 35th conference will be hosted in the state-of-the-art amphitheaters and auditoriums of Kavacik South Campus.",
    newsDesc3: "Under IEEE Turkey Section technical co-sponsorship, all accepted and presented full papers will be submitted to IEEE Xplore.",
    newsDesc4: "Calls for SIU Undergraduate Project Contest, 5-Minute Thesis Competition, and student travel support are now open.",
    newsTag1: "CALL FOR PAPERS",
    newsTag2: "HOST INSTITUTION",
    newsTag3: "PUBLICATION & INDEX",
    newsTag4: "STUDENT AWARDS",
    newsTitle1: "SIU 2027 Call for Papers Published (Deadline: 1 February 2027)",
    newsTitle2: "SIU 2027 Host: Istanbul Medipol University Kavacik Campus",
    newsTitle3: "All Presented Papers Will Be Published in IEEE Xplore Digital Library",
    newsTitle4: "Undergraduate Project Contest and Travel Grants Open",
    nf001: "ERROR 404",
    ...
    nf004: "<a href=\"/\" class=\"btn btn--primary\">Home</a> <a href=\"/yazarlar.html#cfp\" class=\"btn\">Call for Papers</a> <a href=\"/program.html\" class=\"btn\">Scientific Programme</a> <a href=\"/katilim.html#kayit\" class=\"btn\">Registration and Fees</a> <a href=\"/iletisim.html\" class=\"btn\">Contact</a>",
    ...
    pr074: "Keynote speakers have not been finalised yet.",
    pr075: "Three keynote talks are planned for SIU 2027. Speakers and talk titles will be announced in this section and in the conference announcements as invitations are confirmed.",
    pr076: "TUTORIALS AND PANELS",
    pr077: "Tutorials and Panels",
    ...
    programPageDesc: "4-day overall flow, technical sessions filterable by day, hall and track, keynote lectures, and panel discussions.",
    ...
    sponsorsPending: "Corporate sponsorship and exhibition space discussions are ongoing. Supporting organisations will be announced here once confirmed.",
    sponsorsTierHost: "HOST AND ORGANIZING INSTITUTIONS",
    sponsorsTierTech: "TECHNICAL SPONSORSHIP",
    tba101: "SIU 2027 will run for four days, from 4 to 7 July 2027.",
    ...
    tba109: "Social Programme — To Be Announced (TBA)",
    tba110: "A gala dinner and social events programme are planned as part of the conference. The content, date and venue of these events, and whether they are included in registration, will be announced in this section and in the conference announcements once confirmed.",
    tba201: "TBA",
    ...
    tba210: "<strong>Public transport:</strong> Kavacık is a transfer hub reachable by İETT buses from both sides of Istanbul. The stops within walking distance of the campus are marked on the map above; for current route numbers see <a href=\"https://iett.istanbul\" target=\"_blank\" rel=\"noopener\">iett.istanbul</a> or use a maps application.",
    tba211: "<strong>On campus:</strong> the Medipol halls of residence and guesthouse on the Kavacık South Campus are planned to be made available, particularly for students, graduate researchers and participants looking for budget-friendly accommodation. Capacity and pricing will be announced once confirmed. Rooms have high-speed internet, a desk, 24-hour hot water and security.",
    tba301: "Award amounts will be announced once confirmed.",
    tba401: "Opening Session: <strong>4 July 2027</strong> • Time: TBA",
    ...
    theLatestKicker: "THE LATEST & ANNOUNCEMENTS",
    topbarDate: "July 04–07, 2027 | Istanbul",
    topbarSearchBtn: "Search",
    track1Badge: "Wireless & 6G",
    track1Title: "Communications and Networking",
    track2Badge: "Vision & Imaging",
    track2Title: "Image Processing and Computer Vision",
    track3Badge: "Signal Theory & Apps",
    track3Title: "Signal Processing and Applications",
    track4Badge: "ML & AI",
    track4Title: "Machine Learning and Artificial Intelligence",
    track5Badge: "Biomedical Tech",
    track5Title: "Biomedical Signal and Image Processing",
    trackNum1: "TRACK 01",
    trackNum2: "TRACK 02",
    trackNum3: "TRACK 03",
    trackNum4: "TRACK 04",
    trackNum5: "TRACK 05",
    tracksDesc: "Five canonical technical tracks representing the official core research areas of SIU.",
    ...
    yazarlarPageDesc: "Call for Papers (CFP), Microsoft CMT submission portal, standard two-column templates, double-blind review policy, and special session proposals.",
    ...
    yr027: "With contributions from Istanbul Medipol University and the conference sponsors, <strong>travel and free registration support</strong> will be provided to undergraduate and graduate students in need who travel from outside Istanbul to present an accepted paper as an oral or poster presentation.",
    ...
    yz003: "• Topics and Tracks (5 Tracks)",
    ...
    yz011: "The 35th Signal Processing and Communications Applications Conference (SIU 2027) will be held on <strong>4 – 7 July 2027</strong> at the Kavacık Campus of <strong>Istanbul Medipol University</strong>.",
    ...
    yz020: "Full-text papers that are accepted and presented will be submitted to the IEEE Xplore Digital Library.",
    yz022: "CMT Paper Submission System",
    yz023: "OFFICIAL TRACKS",
    yz024: "Topics and Research Tracks",
    yz025: "SIU 2027 accepts original research papers in the <strong>5 official main tracks</strong> listed below and their related subtopics. Beyond these headings, original papers from every theoretical and applied area of signal processing and communications are also welcome:",
    yz026: "Track 1: Communications and Networks",
    yz027: "<span>• Information Theory and Coding</span> <span>• Communication Theory and Applications</span> <span>• Wireless Communications and Networks</span> <span>• 5G, 6G and Beyond</span> <span>• Integrated Sensing and Communication (ISAC)</span> <span>• Internet of Things (IoT) and Vehicular Communications</span> <span>• Satellite, Deep Space and Non-Terrestrial Networks (NTN)</span> <span>• Reconfigurable Intelligent Surfaces (RIS) and MIMO</span> <span>• Optical, Quantum and Molecular Communications</span> <span>• Network Security, Privacy and Physical Layer Security</span> <span>• Edge Computing, Edge Intelligence and Fog Networks</span> <span>• Energy Harvesting, Green Networks and Resource Allocation</span>",
    yz028: "Track 2: Image Processing and Computer Vision",
    yz029: "<span>• Image and Video Processing</span> <span>• Image/Video Coding and Compression</span> <span>• Object Detection, Tracking and Pattern Recognition</span> <span>• Biometric Recognition and Face Processing</span> <span>• Multi-Channel and Multi-Camera Systems</span> <span>• Remote Sensing and Geospatial Analysis</span> <span>• 3D Reconstruction and Computational Photography</span> <span>• Document Analysis, Understanding and OCR</span>",
    yz030: "Track 3: Signal Processing and Applications",
    yz031: "<span>• Statistical and Nonlinear Signal Processing</span> <span>• Audio, Speech and Acoustic Signal Analysis</span> <span>• Radar, Sonar and Array Signal Processing</span> <span>• Smart City and Smart Grid Applications</span> <span>• Signal Processing for Autonomous Systems</span> <span>• Robotics, Automation and Control</span> <span>• Industrial and Automotive Applications</span> <span>• Real-Time Signal Processing and Embedded Systems</span> <span>• Sensor Fusion and Financial Signal Processing</span> <span>• Human–Computer Interaction and Behaviour Analysis</span>",
    yz032: "Track 4: Machine Learning and Artificial Intelligence",
    yz033: "<span>• Machine Learning Theory and Optimisation</span> <span>• Deep Learning Architectures and Models</span> <span>• Natural Language Processing, LLMs and Text Mining</span> <span>• Artificial Intelligence for Communication and Signal Systems</span> <span>• Explainable and Trustworthy Artificial Intelligence (XAI)</span> <span>• Adversarial Learning and Robust Artificial Intelligence</span> <span>• Transfer, Semi-Supervised and Reinforcement Learning</span> <span>• Multimodal Analysis and TinyML</span> <span>• Unsupervised and Generative Models (Diffusion, GAN)</span> <span>• Performance Analysis of Machine Learning Techniques</span>",
    yz034: "Track 5: Biomedical Signal/Image Processing and Applications",
    yz035: "<span>• Biomedical Signal Analysis (EEG, ECG, EMG, etc.)</span> <span>• Medical Image Analysis and Applications (MRI, CT, Ultrasound)</span> <span>• Bioinformatics and Genomic Signal Processing</span> <span>• Wearable Sensors and E-Health Solutions</span> <span>• Biomedical Data Privacy and Security</span> <span>• Artificial Intelligence in Medical Diagnosis</span> <span>• Biosignal Processing for Health Monitoring</span> <span>• Telemedicine and Remote Patient Monitoring</span> <span>• Neuroengineering and Brain Signal Processing</span> <span>• Biomedical Devices and Instrumentation</span>",
    ...
    yz046: "Submissions are accepted only through the official Microsoft CMT (Conference Management Toolkit) system. Papers sent by e-mail will not be processed.",
    yz047: "Step-by-Step Submission Process:",
    yz048: "Click the <a href=\"https://cmt3.research.microsoft.com/SIU2027\" target=\"_blank\" rel=\"noopener\">Microsoft CMT SIU 2027 link</a> and sign in with your account.",
    ...
    yz054: "Microsoft CMT SIU 2027 Submission Portal",
    yz055: "FILE FORMATS",
    ...
    ky024: "Coverage and fees",
    ky025: "The fee table, what registration covers and the cancellation terms are on the Registration page.",
...
function initLangSwitcher() {
  ...
  let currentLang = (urlLang === 'en' || urlLang === 'tr')
    ? urlLang
    : (localStorage.getItem('siu_lang') || 'tr');

  function setLanguage(lang) {
    currentLang = lang;
    localStorage.setItem('siu_lang', lang);
...
function initSearchModal() {
  ...
  const searchIndex = [
    ...
    { title: "Yazar Yönergeleri & Bildiri Şablonları (LaTeX & Word)", url: "yazarlar.html#sablonlar", crumb: "Yazarlar İçin > Şablonlar" },
    { title: "Microsoft CMT Bildiri Gönderim Kılavuzu", url: "yazarlar.html#gonderim", crumb: "Yazarlar İçin > Gönderim" },
    ...
    { title: "Lisans Proje Yarışması (LİSPO)", url: "yarisma.html#lisans", crumb: "Yarışmalar > Lisans Proje" },
    { title: "5 Dakikalık Tez Yarışması (5DTY)", url: "yarisma.html#tez", crumb: "Yarışmalar > Tez Sunumları" },
    { title: "Öğrenci Seyahat & Kayıt Desteği", url: "yarisma.html#destek", crumb: "Yarışmalar > Destek Fonu" },
    { title: "Kayıt Ücretleri Tablosu", url: "katilim.html#kayit", crumb: "Katılım > Kayıt Ücretleri" },
    { title: "İstanbul Medipol Üniversitesi Kavacık Kampüsü Ulaşım", url: "katilim.html#ulasim", crumb: "Katılım > Ulaşım ve Harita" },
...
function initCommitteeBios() {
  ...
  function lang() {
    return localStorage.getItem('siu_lang') === 'en' ? 'en' : 'tr';
  }
  ...
  function open(card) {
    ...
    elRole.textContent = card.querySelector('.committee-role-badge').textContent.trim();
...
function initArchiveMap() {
  ...
  const dil = () => (localStorage.getItem('siu_lang') === 'en' ? 'en' : 'tr');
    ...
    try {
      ...
      if (genelHata) {
        ...
        genelHata.textContent = dil() === 'en'
          ? 'The registration could not be sent. Please check your connection or write to siu-kayit@medipol.edu.tr.'
          : 'Kayıt gönderilemedi. Bağlantınızı kontrol edin ya da siu-kayit@medipol.edu.tr adresine yazın.';
        genelHata.hidden = false;
      }
    } finally {
