...
const i18nDictionary = {
  tr: {
    ...
    navProgramPanels: "Panel Çağrısı",
    ...
    pr078b: "Paneller",
    pr078c: "Panel çağrısı burada duyurulacaktır.",
  ...
  en: {
    ...
    navProgramPanels: "Call for Panels",
    ...
    pr078b: "Panels",
    pr078c: "The call for panels will be announced here.",
...
function initSearchModal() {
  ...
  const searchIndex = [
    ...
    { url: 'program.html#paneller', tr: ['Panel Çağrısı', 'Program › Paneller'], en: ['Call for Panels', 'Programme › Panels'], kw: 'panel çağrı öneri panels call proposal' },
