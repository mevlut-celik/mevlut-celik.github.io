...
const i18nDictionary = {
  tr: {
    ...
    descAboutCommittee: "Kurultay başkanları ve kurullar",
    descAboutHonor: "SİU Onur Kurulu üyeleri",
    ...
    dr05Note: "<a href=\"yazarlar#sablonlar\">Bildiri formatı</a> · <a href=\"#kulvarlar\">Kulvarlar</a>",
    ...
    hk009: "<strong>Sinyal İşleme ve İletişim Uygulamaları Kurultayı'nın 35.'sini (SİU 2027)</strong>, <strong>4–7 Temmuz 2027</strong> tarihlerinde <strong>İstanbul Medipol Üniversitesi</strong> ev sahipliğinde gerçekleştirecek olmanın büyük gurur ve heyecanını yaşıyoruz.",
    hk010: "1993 yılında Boğaziçi Üniversitesi'nde başlatılan SİU geleneği, bugün otuz beşinci yılında Türkiye'nin dört bir yanından ve yurt dışından yüzlerce akademisyeni, genç araştırmacıyı ve sanayi temsilcisini bir araya getiren coşkulu bir bilimsel buluşma olarak sürmektedir.",
    hk011: "Dünya çapında davetli konuşmacılar, eğitim seminerleri ve yüksek kaliteli bir teknik program ile İstanbul'un eşsiz Boğaz manzarasına komşu Kavacık Kampüsünde gerçekleşecek kurultayımıza sizleri davet etmekten memnuniyet duyarız.",
    ...
    navAboutHost: "Kurultay Yeri",
    navAboutHonor: "Onur Kurulu",
    ...
    navCommittees: "Düzenleme Kurulu",
    ...
    trackChair: "Kulvar Eş Başkanları:",
    affOdtu: "ODTÜ",
    affIyte: "İzmir Yüksek Teknoloji Enstitüsü",
    affEtu: "TOBB ETÜ",
    unvanDoc: "Doç. Dr.",
    unvanDrOgr: "Dr. Öğr. Üyesi",
    affBilkent: "Bilkent Üniversitesi",
    affEstu: "Eskişehir Teknik Üniversitesi",
    affHacettepe: "Hacettepe Üniversitesi",
    affIeu: "İzmir Ekonomi Üniversitesi",
    affDeu: "Dokuz Eylül Üniversitesi",
    affSabanci: "Sabancı Üniversitesi",
    ...
    ttlOnurKurulu: "Onur Kurulu | IEEE SİU 2027",
  ...
  en: {
    ...
    btnCommittee: "Organizing Committee",
    ...
    descAboutCommittee: "Conference chairs and committees",
    descAboutHonor: "SIU Honorary Committee members",
    ...
    dr05Note: "<a href=\"yazarlar#sablonlar\">Paper format</a> · <a href=\"#kulvarlar\">Tracks</a>",
    ...
    hk009: "We are proud and delighted to host the <strong>35th Signal Processing and Communications Applications Conference (SIU 2027)</strong> on <strong>July 4–7, 2027</strong> at <strong>Istanbul Medipol University</strong>.",
    hk010: "The SIU tradition, which began at Boğaziçi University in 1993, continues in its thirty-fifth year as a lively scientific gathering that brings together hundreds of academics, early-career researchers and industry representatives from across Türkiye and abroad.",
    hk011: "We are pleased to invite you to the conference at our Kavacık Campus, next to the incomparable Bosphorus view of Istanbul, with world-class keynote speakers, tutorials and a high-quality technical programme.",
    ...
    navAboutHost: "Venue",
    navAboutHonor: "Honorary Committee",
    ...
    navCommittees: "Organizing Committee",
    ...
    trackChair: "Track Co-Chairs:",
    affOdtu: "METU",
    affIyte: "Izmir Institute of Technology",
    affEtu: "TOBB University of Economics and Technology",
    unvanDoc: "Assoc. Prof. Dr.",
    unvanDrOgr: "Asst. Prof. Dr.",
    affBilkent: "Bilkent University",
    affEstu: "Eskişehir Technical University",
    affHacettepe: "Hacettepe University",
    affIeu: "Izmir University of Economics",
    affDeu: "Dokuz Eylül University",
    affSabanci: "Sabancı University",
    ...
    ttlOnurKurulu: "Honorary Committee | IEEE SIU 2027",
...
const committeeBios = {
  ...
  baykas: {
    url: 'https://www.mef.edu.tr/tr/akademik-kadro/2604065213',
    tr: 'Lisans derecesini 2000 yılında Boğaziçi Üniversitesi Elektrik-Elektronik Mühendisliği Bölümü’nden, yüksek lisans ve doktora derecelerini University of Ottawa’dan aldı. 2007’den itibaren Japonya Ulusal Bilgi ve İletişim Teknolojileri Enstitüsü’nde (NICT) uzman araştırmacı olarak uluslararası telsiz haberleşme standartlarının geliştirilmesine katkıda bulundu; ardından İstanbul Medipol Üniversitesi ve Kadir Has Üniversitesi’nde öğretim üyesi olarak görev yaptı. Hâlen MEF Üniversitesi Mühendislik Fakültesi Yapay Zekâ Mühendisliği Bölümü’nde doçenttir. IEEE 802.15.3c, 802.11ad, 802.11af, 802.19 ve 802.11bb standart çalışmalarında editörlük, başkanlık ve başkan yardımcılığı görevleri üstlendi. TÜBA Üstün Başarılı Genç Bilim İnsanı Ödülü (GEBİP, 2017) ve IEEE Standartlar Birliği Ödülü sahibidir.',
    en: 'Tunçer Baykaş received a B.S. in electrical and electronics engineering from Boğaziçi University in 2000, and M.S. and Ph.D. degrees from the University of Ottawa. From 2007, as an expert researcher at the National Institute of Information and Communications Technology (NICT), Japan, Baykaş contributed to the development of international wireless communication standards, and later served as a faculty member at Istanbul Medipol University and Kadir Has University. Baykaş is currently an associate professor in the Department of Artificial Intelligence Engineering, Faculty of Engineering, MEF University, and has served as editor, chair and vice-chair in the IEEE 802.15.3c, 802.11ad, 802.11af, 802.19 and 802.11bb standardisation efforts. Awards include the TÜBA Outstanding Young Scientist Award (GEBİP, 2017) and the IEEE Standards Association Award.'
  },
  gokay: { tr: '', en: '' },
  batgi: { tr: '', en: '' },
  celik: { tr: '', en: '' },
